...
export const tiles = [
  ...
  { id: 't-social-pair', label: 'Social + OH',   col: 2, colSpan: 1, row: 7,  rowSpan: 3, color: '#1C1914', textColor: '#F4F0E8' },
  ...
  { id: 't-interviews', label: 'Interviews',    col: 2, colSpan: 1, row: 11, rowSpan: 4, color: '#2A2218', textColor: '#F4F0E8' },
  { id: 't-app',        label: 'Quill',         col: 1, colSpan: 1, row: 14, rowSpan: 2, color: '#4A2D6A', textColor: '#F4F0E8' },
  { id: 't-custom-1',   label: 'New Tile',      col: 2, colSpan: 1, row: 15, rowSpan: 1, color: '#FAF7F2', textColor: '#F4F0E8' },
