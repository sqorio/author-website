...
export const tiles = [
  ...
  { id: 't-essays',     label: 'Essays',      col: 1, colSpan: 1, row:  6, rowSpan: 2, color: '#3A3530', textColor: '#F4F0E8' },
  { id: 't-accolades',  label: 'Accolades',   col: 2, colSpan: 1, row:  7, rowSpan: 1, color: '#C8601A', textColor: '#F4F0E8' },
  { id: 't-bio',        label: 'Ed Park',     col: 1, colSpan: 1, row:  8, rowSpan: 1, color: '#1C1914', textColor: '#D4A017' },
  { id: 't-social',     label: 'Social',      col: 2, colSpan: 1, row:  8, rowSpan: 2, color: '#1C1914', textColor: '#F4F0E8' },
  { id: 't-stonybrook', label: 'Stony Brook', col: 1, colSpan: 1, row:  9, rowSpan: 3, color: '#E8E4D8', textColor: '#1A1814' },
  { id: 't-quote2',     label: 'Kirkus',      col: 2, colSpan: 1, row: 10, rowSpan: 1, color: '#1C1914', textColor: '#D4A017' },
  { id: 't-app',        label: 'Quill',       col: 2, colSpan: 1, row: 11, rowSpan: 3, color: '#4A2D6A', textColor: '#F4F0E8' },
  { id: 't-mailing',    label: 'Mailing',     col: 1, colSpan: 2, row: 14, rowSpan: 1, color: '#3A3530', textColor: '#F4F0E8' },
  { id: 't-photo2',     label: 'Photo 2',     col: 1, colSpan: 2, row: 15, rowSpan: 2, color: '#1A1510', textColor: '#F4F0E8' },
];
